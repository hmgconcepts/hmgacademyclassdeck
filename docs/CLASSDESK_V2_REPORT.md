...
ClassDesk v2 keeps the existing HMG ACADEMY CLASS DECK UI/UX and pre-existing features, then adds the requested direct tablet broadcasting capabilities:
